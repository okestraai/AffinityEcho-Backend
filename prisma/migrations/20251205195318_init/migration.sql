...
CREATE TABLE "user_profiles" (
    ...
    "company_type" VARCHAR(20) DEFAULT 'static',
...
CREATE TABLE "nooks" (
    ...
    "temperature" VARCHAR(20) NOT NULL DEFAULT 'cool',
    ...
    CONSTRAINT "nooks_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "nook_members" (
    ...
    CONSTRAINT "nook_members_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "nook_messages" (
    "id" UUID NOT NULL,
    "nook_id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    ...
    CONSTRAINT "nook_messages_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "nook_reactions" (
    "id" UUID NOT NULL,
    "nook_id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    ...
    CONSTRAINT "nook_reactions_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "nook_message_reactions" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "nook_message_reactions_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "nooks_expires_at_idx" ON "nooks"("expires_at");

-- CreateIndex
CREATE INDEX "nooks_scope_idx" ON "nooks"("scope");

-- CreateIndex
CREATE INDEX "nooks_is_active_idx" ON "nooks"("is_active");

-- CreateIndex
CREATE INDEX "nooks_created_at_idx" ON "nooks"("created_at");

-- CreateIndex
CREATE INDEX "nook_members_user_id_idx" ON "nook_members"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "nook_members_nook_id_user_id_key" ON "nook_members"("nook_id", "user_id");

-- CreateIndex
CREATE INDEX "nook_messages_nook_id_idx" ON "nook_messages"("nook_id");

-- CreateIndex
CREATE INDEX "nook_messages_user_id_idx" ON "nook_messages"("user_id");

-- CreateIndex
CREATE INDEX "nook_messages_created_at_idx" ON "nook_messages"("created_at");

-- CreateIndex
CREATE INDEX "nook_reactions_nook_id_idx" ON "nook_reactions"("nook_id");

-- CreateIndex
CREATE UNIQUE INDEX "nook_reactions_nook_id_user_id_reaction_type_key" ON "nook_reactions"("nook_id", "user_id", "reaction_type");

-- CreateIndex
CREATE INDEX "nook_message_reactions_message_id_idx" ON "nook_message_reactions"("message_id");

-- CreateIndex
CREATE UNIQUE INDEX "nook_message_reactions_message_id_user_id_reaction_type_key" ON "nook_message_reactions"("message_id", "user_id", "reaction_type");
...
-- AddForeignKey
ALTER TABLE "comment_reactions" ADD CONSTRAINT "comment_reactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "nooks" ADD CONSTRAINT "nooks_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_members" ADD CONSTRAINT "nook_members_nook_id_fkey" FOREIGN KEY ("nook_id") REFERENCES "nooks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_members" ADD CONSTRAINT "nook_members_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_messages" ADD CONSTRAINT "nook_messages_nook_id_fkey" FOREIGN KEY ("nook_id") REFERENCES "nooks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_messages" ADD CONSTRAINT "nook_messages_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_messages" ADD CONSTRAINT "nook_messages_parent_message_id_fkey" FOREIGN KEY ("parent_message_id") REFERENCES "nook_messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_reactions" ADD CONSTRAINT "nook_reactions_nook_id_fkey" FOREIGN KEY ("nook_id") REFERENCES "nooks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_reactions" ADD CONSTRAINT "nook_reactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_message_reactions" ADD CONSTRAINT "nook_message_reactions_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "nook_messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nook_message_reactions" ADD CONSTRAINT "nook_message_reactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
