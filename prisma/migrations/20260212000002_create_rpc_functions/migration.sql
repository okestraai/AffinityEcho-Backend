-- CreateRpcFunctions: All RPC functions used by the application
...
-- Increment topic reaction (dynamic field)
CREATE OR REPLACE FUNCTION increment_topic_reaction(topic_id UUID, reaction_field TEXT)
RETURNS void AS $$
BEGIN
  -- Only allow known reaction fields to prevent SQL injection
...
-- Decrement topic reaction (dynamic field)
...
-- Increment comment reaction (dynamic field)
...
-- Decrement comment reaction (dynamic field)
