...
async function bootstrap() {
    ...
    app.use('/docs', swaggerUi.serve, swaggerUi.setup(document, {
        ...
        customSiteTitle: 'Affinity Echo — API Fortress',
        swaggerOptions: {
    ...
    logger_util_1.default.info('FORTRESS LIVE ON PORT 3000', { module: 'Bootstrap' });
    logger_util_1.default.info('SWAGGER → http://localhost:3000/docs', { module: 'Bootstrap' });
    logger_util_1.default.info('HEALTH  → http://localhost:3000/health', { module: 'Bootstrap' });
}
bootstrap();
